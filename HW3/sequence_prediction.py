...
training_log_file.write(f'Using RNN: {useRNN}, Using LSTM: {useLSTM}, Using GRU: {useGRU}' + '\n')
training_log_file.flush()

print("Loading Sequence...")
# Load data
with open('./data/sequence.txt', 'r', encoding='utf-8') as file:
    data = file.read()
...
class SequenceModel(nn.Module):
    def __init__(self):
        ...
        self.rnn = nn.RNN(input_size=hiddenSize,hidden_size=hiddenSize,batch_first=True)
